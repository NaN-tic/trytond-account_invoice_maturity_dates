...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    download_url='https://github.com:trytonspain/trytond-account_invoice_maturity_dates',
    ...
    project_urls = {
       "Source Code": 'https://github.com:trytonspain/trytond-account_invoice_maturity_dates'
    },
    classifiers=[
